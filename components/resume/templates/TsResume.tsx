            ...
            <div className="wrapper wrapper--narrow">
                <header>
                    ...
                    <div className="m-b-20">
                        <span className="headline headline__text headline--dull">
                            {data.profession}
                        </span>
                ...
                <aside>
                    ...
                    <div>
                        ...
                        <div className="m-b-30">
                            ...
                            <ul>
                                <li className="headline headline__text m-b-30">
                                    Team leadership</li>
                                <li className="headline headline__text m-b-30">
                                Systems design</li>
                            </ul>
                    ...
                    <section className="media-card-3">
                        ...
                        <div className="profile__cta"><a className="button">Adopt Doggo!</a></div>
                        </div>
                    </section>

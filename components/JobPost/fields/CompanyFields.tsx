...
const CompanyFields = ({ register, errors }: any) => {
  return (
    <>
      <div className="flex flex-gap-l">
        <div className="field__input__wrapper">
          <label htmlFor="companyName" className="headline headline__text">
            <b>Company Name</b>
          </label>
          <input
            id="companyName"
        ...
        <div className="field__input__wrapper">
          <label htmlFor="companyWebsite" className="headline headline__text">
            <b>Company Website</b>
          </label>
          <input
            id="companyWebsite"
      ...
      <div className="field__input__wrapper">
        <label htmlFor="CompanyHeadquarter" className="headline headline__text">
      ...
      <div className="text-editor">
        ...
        <label id="editor-text">Click or drag your photo here to upload </label>
      </div>

      <div className="input-area field__input__wrapper" id="divKeywords">
        <label htmlFor="companyContent" className="headline headline__text">
          <b>
            Company Description <i>(Markdown)</i>
          </b>
        </label>
